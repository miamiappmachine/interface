...
export const colors = {
  ...
  surface2_dark: '#00071b',
  surface2_hovered_dark: '#242424',
  surface3_dark: '#FFFFFF12',
  surface3_hovered_dark: 'rgba(255, 255, 255, 0.16))',
  surface4_dark: '#FFFFFF20',
  surface5_dark: '#00000004',
  accent1_dark: '#00BE50',
  accent2_dark: '#00071b',
  accent3_dark: '#5E5E5E',
  neutral1_light: '#FFFFFF',
  neutral2_light: '#9B9B9B',
  neutral3_light: '#5E5E5E',
  surface1_light: '#131313',
  surface1_hovered_light: '#181818',
  surface2_light: '#00071b',
  surface2_hovered_light: '#242424',
  surface3_light: '#FFFFFF12',
  surface3_hovered_light: 'rgba(255, 255, 255, 0.16))',
  surface4_light: '#FFFFFF20',
  surface5_light: '#00000004',
  accent1_light: '#00BE50',
  accent2_light: '#00071b',
  accent3_light: '#5E5E5E',
  success: '#40B66B',
  critical: '#FF5F52',
  critical2_dark: '#2E0805',
  critical2_light: '#2E0805',
